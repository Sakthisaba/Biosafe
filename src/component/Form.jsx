...
{  const [img,setImg] = useState(0)
   ...
   case 0:
    return (<>
               <ModalHeader className={`mb-6`}>Registration</ModalHeader>
             <ModalBody>
   ...
   case 1:
    return (<>
          <ModalBody className={`${style.flexCenter} flex-col`}>
              ...
              <Text className={`font-poppins font-semibold text-center `}>Register With biometric</Text>
        ...
        case 2:
            ...
            <div className={`flex flex-row justify-around m-4`}>
            <Button colorScheme='teal' variant='outline' onClick={()=>setCount(count-1)}>Back</Button>
            <Button colorScheme='teal' variant='solid' onClick={(e)=>{Upload(img,email)}}>Submit</Button>
            </div>
