...
console.log("after compressed 1: " + compressed);
console.log("length: " + compressed.length);
var compressed1 = hm.compress(compressed);
console.log("after compressed 2: " + compressed1);
console.log("length: " + compressed1.length);
